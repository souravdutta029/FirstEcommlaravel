...
@foreach( $get_all_product as $v_get_all_product)
<div class="col-sm-4">
    <div class="product-image-wrapper">
        <div class="single-products">
                <div class="productinfo text-center">
                    <img src="{{ URL::to($v_get_all_product->product_image) }}" alt="" style="height: 268px; width: 249px;" />
                    <h2>INR {{ $v_get_all_product->product_price }}</h2>
                    <p>{{ $v_get_all_product->product_name }}</p>
