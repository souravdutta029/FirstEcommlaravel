                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                <li><a href="#"><i class="fa fa-phone"></i> +91 79 80 20 4716</a></li>
        ...
        <div class="header-middle"><!--header-middle-->
            ...
            <div class="col-sm-8">
                ...
                <ul class="nav navbar-nav">
                    ...
                    ?>
                    @if($customer_name)
                        <li><h4><span style="color: #FFAC40;">Welcome !!!</span> <b>{{$customer_name}}</b></h4></li>
                    @else
                    @endif
            ...
            <div class="left-sidebar">
                ...
                <div class="panel-group category-products" id="accordian"><!--category-productsr-->
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title"><a href="/product-by-category/{{ $published_category->category_id }}">{{ $published_category->category_name }}</a></h4>
                        </div>
                        <?php } ?>
                    </div>
                ...
                <div class="brands_products"><!--brands_products-->
                    ...
                    <div class="brands-name">
                        ...
                        ?>
                        <?php 
                            foreach($all_published_brands as $published_brand){
                        ?>
                        <ul class="nav nav-pills nav-stacked">
                            <li><a href="/product-by-brand/{{ $published_brand->brand_id }}"> <span class="pull-right">50</span>{{ $published_brand->brand_name }}</a></li>
                        </ul>
                        <?php } ?>
                    </div>
                </div><!--/brands_products-->
